...
<body>
  ...
  <!-- == Main Control Area MOVED to TOP == -->
  <div class="section-main-control">
    ...
    <div class="input-group" style="text-align: center; width: 100%;">
      ...
      <button class="button" onclick="sendCommand('ENTER_PICKPLACE')">Pick and Place Mode</button> 
      <button class="button exit-button" onclick="sendCommand('STOP')">STOP</button>
    </div>
  </div>
  <hr>
  <!-- ========================== -->
